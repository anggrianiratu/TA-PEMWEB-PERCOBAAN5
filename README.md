...
<p align="justify">
Aplikasi ini merupakan kalkulator berbasis web yang dapat melakukan operasi aritmatika dasar, mendukung perhitungan berantai, 
menyediakan riwayat perhitungan, serta memiliki fungsi memori seperti pada kalkulator fisik. Aplikasi ini dirancang agar mudah digunakan, 
memiliki fitur lengkap, dan tetap responsif untuk tampilan mobile maupun desktop.
</p>

## Fitur Utama

1. Interface
   * Display untuk menampilkan angka dan hasil.
   * Tombol angka 0–9.
   * Tombol operator +, –, ×, ÷.
   * Tombol Clear (C) untuk menghapus semua.
